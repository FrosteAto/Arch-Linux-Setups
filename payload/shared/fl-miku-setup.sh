...
select_install_mode() {
  ...
  echo "  8) VOCALOID6 Editor"
  echo "  9) Hatsune Miku V6 voicebank"
  echo
  local choice
  while true; do
    ...
    case "$choice" in
      ...
      7)
        ...
        ;;
      8)
        log "Will install: VOCALOID6 Editor"
        INSTALL_COMPONENTS=(vocaloid6_editor)
        return 0
        ;;
      9)
        log "Will install: Hatsune Miku V6 voicebank"
...
# ---------------------------------------------------------------------------
# VOCALOID6 Editor + Hatsune Miku V6 voicebank
# ---------------------------------------------------------------------------
# VOCALOID6 requires online activation on first launch.
# vcrun2022 is already installed by the Piapro/Mutant MSI step.
# ---------------------------------------------------------------------------
...
main() {
  ...
  if should_install "miku_v6";        then run_miku_v6_installer;           fi
