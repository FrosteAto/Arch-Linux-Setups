...
[default_session]
command = "tuigreet --remember --remember-session --time --greeting God created angels to carry his message. What will you have me transmit? --cmd /usr/bin/startplasma-wayland"
EOF
